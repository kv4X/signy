...
export const LetterScreen = ({ navigation }) => {
  ...
  const CourseItemHeader = (props) => (
    ...
    <View style={{backgroundColor: 'transparent', paddingHorizontal: 24, paddingVertical: 16}}>
      ...
      <Text category='s1'>Press to start animation</Text>
    </View>
  );
  const Header = (props) => (
    ...
    alignItems: 'center'}}>
         <Image
          style={{resizeMode: 'stretch', width: 200, height: 200,justifyContent: 'center',
          alignItems: 'center'}}
          source={{
            uri: 'https://i.imgur.com/ZljNPkv.png',
          }}
        />
      <Text category='h6'>Letter A</Text>
      <Text category='s1'>Lection 1/26s</Text>
    </View>
  );
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors['background-basic-color-1'] }}>
      ...
      <TopNavigation
        ...
        alignment='start'
        title={props => <Text style={{color: colors['background-basic-color-1'], textTransform: 'uppercase'}}>Letter Section</Text>}
        style={{ position: 'absolute', backgroundColor: 'transparent' }}
      />
      <View style={styles.Stilizuj}>
        <Card style={styles.card2} header={Header} />
      </View>
      <ScrollView style={styles.scrollView}>
        <CourseItem name="Apple" imageUrl="https://i.imgur.com/ZljNPkv.png"/>
        <CourseItem name="Avocado" imageUrl="https://i.imgur.com/ZljNPkv.png"/>
        <CourseItem name="Avocado" imageUrl="https://i.imgur.com/ZljNPkv.png"/>
        <CourseItem name="Avocado" imageUrl="https://i.imgur.com/ZljNPkv.png"/>
        <CourseItem name="Avocado" imageUrl="https://i.imgur.com/ZljNPkv.png"/>
        <CourseItem name="Avocado" imageUrl="https://i.imgur.com/ZljNPkv.png"/>
